...
--local-scheduler  \
--data-frames-preparation-extra-params '{"sample_days": 4, "history_window": 10, "column_stratification": "SessionID"}' \
--path-item-embedding "/media/workspace/triplet_session/output/models/TripletTraining/results/TripletTraining____mars_gym_model_b____e18c3fa0be/item_embeddings.npy" \
--from-index-mapping "/media/workspace/triplet_session/output/models/TripletTraining/results/TripletTraining____mars_gym_model_b____e18c3fa0be/index_mapping.pkl" \
--test-split-type time \
--dataset-split-method column \
--run-evaluate  \
