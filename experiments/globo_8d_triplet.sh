...
# TripletTraining____mars_gym_model_b____87aba5460d
...
--recommender-extra-params '{
  ...
  "dropout": 0.1, 
  "hist_size": 10, 
  "from_index_mapping": "/media/workspace/triplet_session/output/models/TripletTraining/results/TripletTraining____mars_gym_model_b____87aba5460d/index_mapping.pkl",
  "path_item_embedding": "/media/workspace/triplet_session/output/models/TripletTraining/results/TripletTraining____mars_gym_model_b____87aba5460d/item_embeddings.npy", 
  "freeze_embedding": false}' \
--data-frames-preparation-extra-params '{"sample_days": 8, "history_window": 10, "column_stratification": "SessionID"}' \
--early-stopping-min-delta 0.0001 \
--negative-proportion 0.8 \
...
--epochs 100 \
--run-evaluate  \
--sample-size-eval 5000 --obs "exp 6"
