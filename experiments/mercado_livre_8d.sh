...
PYTHONPATH="."  luigi  \
 ...
 --project mercado_livre.config.mercado_livre_triplet  \
...
--project mercado_livre.config.mercado_livre_interaction_with_negative_sample \
...
# Only Map
mars-gym run supervised \
--project mercado_livre.config.mercado_livre_mf_bpr \
